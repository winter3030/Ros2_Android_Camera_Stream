...
public class SettingArrayList {
    ...
    public SettingArrayList() {
        ...
        settinglist.add(new Setting("VGA 640x480",true,"VGA","B"));
        ...
        settinglist.add(new Setting("PNG",true,"PNG","B"));
        settinglist.add(new Setting("JPG",false,"JPG","B"));
        settinglist.add(new Setting("Ros2 QOS 模式",false,"Ros2 QOS 模式","A"));
        settinglist.add(new Setting("Default(Reliable)",true,"Default","B"));
